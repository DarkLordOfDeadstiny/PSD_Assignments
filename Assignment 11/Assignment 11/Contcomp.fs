...
let rec addIFZERO lab3 C : instr list =
    match C with
    | GOTO lab2 :: Label ll :: C1 when ll = lab3 -> IFNZRO lab2 :: Label lab3 :: C1
    | _ -> IFZERO lab3 :: C
...
let rec addCST i C =
    ...
    | (a, CSTI b :: EQ :: NOT :: C1) -> addCST (a-b) C1
    | (a, CSTI b :: SWAP :: LT :: NOT :: C1) -> if a <= b then addCST 1 C1
                                                else addCST 0 C1
    | (a, CSTI b :: SWAP :: LT :: C1) -> if a > b then addCST 0 C1
                                         else addCST 1 C1
    | (a, CSTI b :: LT :: NOT :: C1) -> if a >= b then addCST 1 C1
                                        else addCST 0 C1
    | (a, CSTI b :: LT :: C1) -> if a < b then addCST 1 C1
                                 else addCST 0 C1
    | _                     -> CSTI i :: C
